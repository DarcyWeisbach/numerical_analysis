...
#include <stdlib.h>
#include <math.h>
//cl /source-charset:utf-8 exercises4-2.cpp /EHsc
#define N 4 /* N次正方行列 */
...
int main(void){
	...
	errno_t error;
    if((error=fopen_s(&fin,"input_exercises4-2.dat","r"))!=0) exit(1);
    if((error=fopen_s(&fout,"output_exercises4-2.dat","w"))!=0) exit(1);
